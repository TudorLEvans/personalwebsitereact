...
const HomePageView = () => {
    ...
    return (
        <div class="w-fill sm:pt-32">
            ...
            <div class="flex-column justify-center lg:mb-32 pt-6 sm:pt-20">
                <section id='section-1' class="justify-center section-1 w-full">
                    <p class="text-5xl md:text-6xl text-center font-thin leading-loose">Tudor Lucien Evans</p>
                ...
                <section id='section-2' class="flex bg-primary-colour pt-12 pb-12 w-full text-white" >
                    <div class="lg:w-1/3"/>
                    <div class="lg:w-1/3 lg:p-0 p-4">
                    <p class="text-5xl md:text-6xl text-center font-thin leading-loose">Education</p>
                ...
                <div class="lg:w-1/3"/>
                <div class="lg:w-1/3 lg:p-0 p-4">
                    <p class="text-5xl lg:text-6xl text-center font-thin leading-loose">Career</p>
                    <p class=" text-xl text-center font-hairline mb-4 leading-loose">
                ...
                <div class="lg:w-1/3"/>
                <div class="lg:w-1/3 lg:p-0 p-4">
                    <p class="text-5xl lg:text-6xl text-center font-thin leading-loose">Skills</p>
                    <p class=" text-xl text-center font-hairline mb-4 leading-loose">
                ...
                <div class="lg:w-1/3"/>
                <div class="lg:w-1/3 lg:p-0 p-4">
                    <p class="text-5xl lg:text-6xl text-center font-thin leading-loose">Interests</p>
                    <p class=" text-xl text-center font-hairline mb-4 leading-loose">
